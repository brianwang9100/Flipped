...
OFILES = main.o mylib.o font.o grounds.o whiteorbs.o blackorbs.o startscene.o winscene.o losescene.o 

# The header files you have created.
# This is necessary to determine when to recompile for files.
# This should be a space (SPACE!) separated list of .h files
HFILES = main.h mylib.h grounds.h whiteorbs.h blackorbs.h startscene.h winscene.h losescene.h
